...
(49,9,'','测试','','','1,3','','','','','','测试','/public/cover/01.jpg','<p>测试</p>',0,4,'','2023-11-07 11:08:35','2023-11-07 11:08:35'),
...
(1,0,'前端开发','前端开发，es6,es5,javascript,js,css3,微信小程序','前端开发常用知识，包括es6,es5,javascript,js,css3,微信小程序等常见开发。','前端开发','qianduankaifa','/qianduankaifa','','0','',0,'0','0','0','list.html','article.html'),
(2,0,'','','','nodejs开发','nodejskaifa','/nodejskaifa','','0','',0,'0','0','0','list.html','article.html'),
(3,0,'','','','禅悦文档','chanyuewendang','/chanyuewendang','','0','',0,'0','0','0','list.html','article.html'),
(5,0,'','','','禅悦cms','chanyuecms','/chanyuecms','','1','',0,'0','0','0','list.html','chanyue.html'),
...
(8,0,'','','','关于作者','guanyuzuozhe','/guanyuzuozhe','','1','',0,'0','0','0','list.html','page.html'),
(9,1,'','','','JavaScript','JavaScript','/qianduankaifa/JavaScript','','0','',0,'0','0','0','list.html','article.html'),
(10,1,'','','','css','css','/qianduankaifa/css','','0','',0,'0','0','0','list.html','article.html'),
(11,2,'','','','mysql','mysql','/nodekaifa/mysql','','0','',0,'0','0','0','list.html','article.html'),
(13,1,'','','','vue','vue','/qianduankaifa/vue','','0','',0,'0','0','0','list.html','article.html'),
(14,1,'','','','小程序','xiaochengxu','/qianduankaifa/xiaochengxu','','0','',0,'0','0','0','list.html','article.html');
...
(1,'前端小栈','www.angyi.com','867528315@qq.com',NULL,NULL,'','{\"siteSubtitle\":\"• 禅悦\"}','chanyue-cms禅悦内容管理系统','chanyue-cms|禅悦cms|nodejs|express|mysql','禅悦CMS是一款基于Express和MySQL研发的高质量实用型CMS管理系统。它具备多种类型网站开发，易扩展、基于模块化和插件化开发模式，适用于商用企业级程序开发。',NULL,'2023-11-07 13:40:47',NULL,NULL,NULL);
...
insert  into `slide`(`id`,`title`,`img_url`,`link_url`,`createdAt`,`updatedAt`,`mark`) values 
(1,'首页','/public/template/angke/img/banner.jpg','','2023-11-05 23:29:14','2023-11-05 23:33:31',NULL);
...
insert  into `sys_app`(`id`,`template`,`appid`,`secret`,`accessKey`,`secretKey`,`domain`,`bucket`,`uploadWay`,`createdAt`,`updatedAt`,`maxAge`,`dataCache`) values 
(1,'default','s','x','x','x','x','x','1','2023-10-07 21:52:21','2023-11-08 11:44:23','2','2');
