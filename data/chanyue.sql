...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`chanyue` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='管理员后期换成sys_user';
...
CREATE TABLE `article` (
  ...
  `sub_cid` varchar(255) DEFAULT NULL COMMENT '其它栏目id',
...
) ENGINE=InnoDB AUTO_INCREMENT=96 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='文章-标签表';

/*Data for the table `article_map_tag` */

insert  into `article_map_tag`(`id`,`aid`,`tid`) values 
(20,7,0),
(22,6,2),
(23,6,1),
(27,1,0),
...
CREATE TABLE `category` (
  ...
  `seo_keywords` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'seo关键字',
  `seo_description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'seo描述',
  `name` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '栏目名称',
  `pinyin` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '栏目标识',
  `path` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '栏目路径',
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '栏目描述',
  ...
  `list_view` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'list.html' COMMENT '列表页模板',
  `article_view` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT 'article.html' COMMENT '详情页模板',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='网站栏目';

/*Data for the table `category` */

insert  into `category`(`id`,`pid`,`seo_title`,`seo_keywords`,`seo_description`,`name`,`pinyin`,`path`,`description`,`type`,`url`,`sort`,`target`,`status`,`mid`,`list_view`,`article_view`) values 
(1,0,'前端开发','前端开发，es6,es5,javascript,js,css3,微信小程序','前端开发常用知识，包括es6,es5,javascript,js,css3,微信小程序等常见开发。','前端开发','fedev','/fedev','','0','',0,'0','0','0','list.html','article.html'),
(2,0,'','','','node开发','nodejs','/nodejs','','0','',0,'0','0','0','list.html','article.html'),
(3,0,'','','','前端库','qianduanku','/qianduanku','','0','',0,'0','0','0','list.html','article.html'),
(4,0,'','','','SEO','SEO','/SEO','','0','',0,'0','0','0','list.html','article.html'),
(5,0,'','','','禅悦cms','chanyue','/chanyue','','1','',0,'0','0','0','list.html','chanyue.html'),
(6,2,'','','','express','express','/nodejs/express','','0','',0,'0','0','0','list.html','article.html'),
(7,2,'','','','服务运维','fuwuyunwei','/nodejs/fuwuyunwei','','0','',0,'0','0','0','list.html','article.html'),
(8,0,'','','','关于','guanyu','/guanyu','','1','',0,'0','0','0','list.html','page.html'),
(9,1,'','','','JavaScript','JavaScript','/qianduankaifa/JavaScript','','0','',0,'0','0','0','list.html','article.html'),
(10,1,'','','','vue','vue','/qianduankaifa/vue','','0','',0,'0','0','0','list.html','article.html'),
(11,2,'','','','mysql','mysql','/nodekaifa/mysql','','0','',0,'0','0','0','list.html','article.html'),
(12,3,'','','','采集测试','caijiceshi','/qianduanku/caijiceshi','','0','',0,'0','0','0','list.html','article.html'),
(13,1,'','','','css3','css3','/fedev/css3','','0','',0,'0','0','0','list.html','article.html');
...
CREATE TABLE `collect` (
  ...
  `clearRegCode` text COLLATE utf8mb4_unicode_ci COMMENT '清理文章多余标签正则',
  `removeCode` text COLLATE utf8mb4_unicode_ci COMMENT '清理代码',
  `cid` int(11) DEFAULT NULL COMMENT '存储到栏目',
...
insert  into `collect`(`id`,`taskName`,`targetUrl`,`listTag`,`startNum`,`endNum`,`increment`,`titleTag`,`articleTag`,`charset`,`pages`,`clearRegCode`,`removeCode`,`cid`,`status`,`createdAt`,`updatedAt`) values 
(1,'草堂札记','http://www.tangnet.cn/lists/31.html?page=${page}','.news-list h5 a',1,1,'1','.title h1','.content','1','http://www.tangnet.cn/news/46.html,http://www.tangnet.cn/news/44.html,http://www.tangnet.cn/news/43.html,http://www.tangnet.cn/news/42.html,http://www.tangnet.cn/news/37.html,http://www.tangnet.cn/news/27.html,http://www.tangnet.cn/news/28.html,http://www.tangnet.cn/news/31.html,http://www.tangnet.cn/news/26.html,http://www.tangnet.cn/news/24.html','',NULL,12,'2','2023-09-29 19:33:57','2023-09-29 20:05:09');
...
CREATE TABLE `down` (
  `aid` int(11) NOT NULL,
  `downName` varchar(100) NOT NULL DEFAULT '',
  `downLink` varchar(100) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

/*Data for the table `down` */
...
CREATE TABLE `field` (
  ...
  `field_cname` varchar(60) DEFAULT NULL COMMENT '模型字段中文名称',
  `field_ename` varchar(60) DEFAULT '' COMMENT '模型字段英文名称',
  `field_type` varchar(10) DEFAULT NULL COMMENT '表单类型\r\n1单行文本	\r\n2.多行文本 \r\n3.下拉菜单 \r\n4.单选 \r\n5.多选 \r\n6.时间和日期 7.数字',
  `field_values` varchar(255) DEFAULT NULL COMMENT '字段配置 下拉菜单多选等选项配置',
  `field_default` varchar(255) DEFAULT NULL COMMENT '默认值',
  `field_sort` varchar(255) DEFAULT '0' COMMENT '字段顺序',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `model_id` (`model_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='字段字典';

/*Data for the table `field` */

insert  into `field`(`id`,`model_id`,`field_cname`,`field_ename`,`field_type`,`field_values`,`field_default`,`field_sort`) values 
(1,1,'下载名称','downName','1','','','0'),
(2,1,'下载链接','downLink','1','','','0');

/*Table structure for table `frag` */
...
insert  into `friendlink`(`id`,`title`,`link`,`sort`,`createdAt`) values 
(1,'香港日报','http://www.hongkongdaily.net',0,'2023-07-22 22:59:55');
...
CREATE TABLE `login_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`,`createdAt`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4;

/*Data for the table `login_log` */

insert  into `login_log`(`id`,`uid`,`ip`,`createdAt`) values 
(1,1,'127.0.0.1','2023-11-01 17:01:53'),
(2,3,'127.0.0.1','2023-11-01 17:38:53'),
(3,1,'127.0.0.1','2023-11-01 17:39:49'),
(4,3,'127.0.0.1','2023-11-01 17:51:16'),
(5,2,'127.0.0.1','2023-11-01 17:51:57');
...
CREATE TABLE `model` (
  ...
  `table_name` varchar(10) DEFAULT NULL COMMENT '模型对应的表名',
...
insert  into `model`(`id`,`model_name`,`table_name`,`status`) values 
(1,'down','down','1');
...
CREATE TABLE `site` (
  ...
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  `template` varchar(20) DEFAULT NULL COMMENT 'view模板',
  `appid` varchar(50) DEFAULT NULL COMMENT '微信小程序appid',
  `secret` varchar(50) DEFAULT NULL COMMENT '微信小程序secret',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='网站信息';

/*Data for the table `site` */

insert  into `site`(`id`,`name`,`domain`,`email`,`wx`,`icp`,`code`,`json`,`title`,`keywords`,`description`,`createdAt`,`updatedAt`,`template`,`appid`,`secret`) values 
(1,'前端小栈','www.chanyue.top','867528315@qq.com',NULL,NULL,'','{\"siteSubtitle\":\"• 禅悦\"}','chanyue-cms禅悦内容管理系统','cms,chanyue-cms,chanyue,内容管理系统,nodejs,express,mysql,knex,jwt,vue3','禅悦内容管理系统，基于nodejs express mysql knex jwt vue3 进行开发的一套实用轻量cms系统，且提供丰富的api数据接口。常用企业网站，微信小程序官网，图片网站，新闻资讯，软件下载网站，博客，文章等诸多文章类型网站开发，也适用于前端二次开发。',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `sys_app` (
  `id` int(2) NOT NULL AUTO_INCREMENT,
  `template` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'default' COMMENT 'view模板名称',
  `appid` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '微信小程序appid',
  `secret` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '微信小程序秘钥',
  `accessKey` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '七牛云ak',
  `secretKey` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '七牛云sk',
  `domain` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '七牛云域名',
  `bucket` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '七牛云bucket',
  `uploadWay` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '上传方式 1->普通 2->七牛云',
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
insert  into `sys_app`(`id`,`template`,`appid`,`secret`,`accessKey`,`secretKey`,`domain`,`bucket`,`uploadWay`,`createdAt`,`updatedAt`) values 
(1,'default','s','x','x','x','x','x','1','2023-10-07 21:52:21','2023-10-13 09:38:27');
...
CREATE TABLE `sys_role` (
  ...
  `value` varchar(30) DEFAULT NULL COMMENT '角色值',
...
insert  into `sys_role`(`id`,`name`,`value`,`sort`,`status`,`createdAt`,`updatedAt`,`remark`) values 
(1,'超级管理员','super',0,'1','2023-10-30 21:57:52','2023-10-30 22:00:50',NULL),
(2,'普通管理员','admin',0,'1','2023-10-30 22:01:04','2023-10-30 22:01:04',NULL),
(3,'编辑管理','editor',0,'1','2023-10-30 22:01:11','2023-10-30 22:02:14',NULL);
...
insert  into `sys_user`(`id`,`role_id`,`username`,`password`,`status`,`createdAt`,`updatedAt`,`remark`) values 
(1,'2','chanyue','1d73632ebe6497078f6744bf79bd2861','1','2023-10-30 22:42:01','2023-10-30 23:39:18',NULL),
(2,'1','yanyutao','1d73632ebe6497078f6744bf79bd2861','1','2023-10-30 22:42:18','2023-10-30 23:55:42',NULL),
(3,'3','张三','1d73632ebe6497078f6744bf79bd2861','1','2023-10-31 00:06:55','2023-10-31 00:06:55',NULL);
...
CREATE TABLE `tag` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='标签';

/*Data for the table `tag` */

insert  into `tag`(`id`,`name`,`path`) values 
(1,'cms','cms'),
(2,'js库','jslib'),
(3,'开发工具','devtool'),
(4,'pdf','pdf');
