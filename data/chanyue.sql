...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='文章表';
...
) ENGINE=InnoDB AUTO_INCREMENT=102 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='文章-标签表';
...
CREATE TABLE `category` (
  ...
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='网站栏目';

/*Data for the table `category` */

insert  into `category`(`id`,`pid`,`seo_title`,`seo_keywords`,`seo_description`,`name`,`pinyin`,`path`,`description`,`type`,`url`,`sort`,`target`,`status`,`mid`,`list_view`,`article_view`,`createdAt`,`updatedAt`) values 
(1,0,'前端开发','前端开发，es6,es5,javascript,js,css3,微信小程序','前端开发常用知识，包括es6,es5,javascript,js,css3,微信小程序等常见开发。','前端开发','qianduankaifa','/qianduankaifa','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL),
(2,0,'','','','nodejs开发','nodejskaifa','/nodejskaifa','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL),
(3,0,'','','','禅悦文档','chanyuewendang','/chanyuewendang','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL),
(5,0,'','','','禅悦cms','chanyuecms','/chanyuecms','','1','',0,'0','0','0','list.html','chanyue.html','2023-11-25 12:52:03',NULL),
(6,2,'','','','express','express','/nodejs/express','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL),
(7,2,'','','','服务运维','fuwuyunwei','/nodejs/fuwuyunwei','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL),
(8,0,'','','','关于作者','guanyuzuozhe','/guanyuzuozhe','','1','',0,'0','0','0','list.html','page.html','2023-11-25 12:52:03',NULL),
(9,1,'','','','JavaScript','JavaScript','/qianduankaifa/JavaScript','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL),
(10,1,'','','','css','css','/qianduankaifa/css','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL),
(11,2,'','','','mysql','mysql','/nodekaifa/mysql','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL),
(13,1,'','','','vue','vue','/qianduankaifa/vue','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL),
(14,1,'','','','小程序','xiaochengxu','/qianduankaifa/xiaochengxu','','0','',0,'0','0','0','list.html','article.html','2023-11-25 12:52:03',NULL);
...
CREATE TABLE `frag` (
  ...
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='碎片';

/*Data for the table `frag` */

insert  into `frag`(`id`,`name`,`mark`,`content`,`type`,`createdAt`,`updatedAt`) values 
...
(8,'首页轮播图','homeSlide','<p><img src=\"/public/template/angke/img/banner.jpg\" alt=\"\"></p>','1','2023-11-05 22:29:01','2023-11-25 12:45:07'),
(9,'我就是用来测试的','test','chanyue-cms 值得拥有','1','2023-11-08 14:58:19','2023-11-25 12:45:07');
...
CREATE TABLE `friendlink` (
  ...
  `sort` tinyint(255) DEFAULT '0' COMMENT '排序',
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
insert  into `friendlink`(`id`,`title`,`link`,`sort`,`createdAt`,`updatedAt`) values 
(1,'香港日报','http://www.hongkongdaily.net',0,'2023-07-22 22:59:55','2023-11-25 12:44:34');
...
CREATE TABLE `gather` (
  ...
  `taskName` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '任务名称',
  `targetUrl` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '采集地址',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '标题字段',
  `content` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '内容字段',
  `cid` int(11) DEFAULT NULL COMMENT '存储到栏目',
  `status` varchar(1) COLLATE utf8mb4_unicode_ci DEFAULT '1' COMMENT '发布状态 1 草稿 2 发布',
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='开源接口采集';

/*Data for the table `gather` */

insert  into `gather`(`id`,`taskName`,`targetUrl`,`title`,`content`,`cid`,`status`,`createdAt`,`updatedAt`) values 
(2,'60秒读懂世界','https://api.qqsuu.cn/api/dm-60s?type=json','name','data',1,'1','2023-11-29 16:22:38','2023-11-29 16:23:04'),
(3,'60s1','https://api.qqsuu.cn/api/dm-60s?type=json','name','data',1,'2','2023-11-29 19:10:45','2023-11-29 19:36:06');
...
(6,1,'127.0.0.1','2023-11-01 21:55:40'),
(7,3,'127.0.0.1','2023-11-01 22:11:35'),
(8,1,'127.0.0.1','2023-11-01 22:11:51'),
(9,2,'127.0.0.1','2023-11-01 22:13:49'),
(10,3,'127.0.0.1','2023-11-01 22:14:09'),
(11,2,'127.0.0.1','2023-11-05 21:39:45'),
(12,2,'127.0.0.1','2023-11-05 23:18:19'),
(13,1,'127.0.0.1','2023-11-05 23:19:20'),
(14,2,'127.0.0.1','2023-11-05 23:41:48'),
(15,1,'127.0.0.1','2023-11-05 23:58:42'),
(16,2,'127.0.0.1','2023-11-05 23:59:06'),
(17,1,'127.0.0.1','2023-11-07 09:35:47'),
(18,1,'127.0.0.1','2023-11-08 11:22:11'),
(19,1,'127.0.0.1','2023-11-25 12:59:36'),
(20,2,'127.0.0.1','2023-11-25 13:00:00'),
(21,1,'127.0.0.1','2023-11-25 13:05:01'),
(22,1,'127.0.0.1','2023-11-25 18:04:58'),
(23,1,'127.0.0.1','2023-11-26 11:56:25'),
(24,1,'127.0.0.1','2023-11-27 17:29:21'),
(25,2,'127.0.0.1','2023-11-27 17:30:37'),
(26,1,'127.0.0.1','2023-11-29 15:31:16'),
(27,2,'127.0.0.1','2023-11-29 15:33:34');
...
insert  into `message`(`id`,`name`,`tel`,`company`,`content`,`createdAt`,`updatedAt`) values 
(1,'闫宇韬','13366826071','天山派','仰天大笑出门去，我辈岂是蓬蒿人！','2023-11-25 12:42:23','2023-11-25 12:42:23');
...
insert  into `site`(`id`,`name`,`domain`,`email`,`wx`,`icp`,`code`,`json`,`title`,`keywords`,`description`,`template`,`appid`,`secret`,`createdAt`,`updatedAt`) values 
(1,'前端小栈','1cms.top','867528315@qq.com',NULL,NULL,'','禅悦','chanyue-cms禅悦内容管理系统','chanyue-cms|禅悦cms|nodejs|express|mysql','禅悦CMS是一款基于Express和MySQL研发的高质量实用型CMS管理系统。它具备多种类型网站开发，易扩展、基于模块化和插件化开发模式，适用于商用企业级程序开发。',NULL,NULL,NULL,NULL,'2023-11-27 17:30:03');
...
CREATE TABLE `slide` (
  ...
  `img_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '轮播图',
  `link_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '轮播链接',
...
insert  into `slide`(`id`,`title`,`img_url`,`link_url`,`mark`,`createdAt`,`updatedAt`) values 
(1,'首页','/public/template/angke/img/banner.jpg','',NULL,'2023-11-05 23:29:14','2023-11-05 23:33:31');
...
CREATE TABLE `sys_app` (
  ...
  `maxAge` tinytext COLLATE utf8mb4_unicode_ci COMMENT '静态资源缓存 1开启 2关闭',
  `dataCache` tinytext COLLATE utf8mb4_unicode_ci COMMENT '全局模板数据缓存 1开启 2关闭',
  `createdAt` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updatedAt` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
insert  into `sys_app`(`id`,`template`,`appid`,`secret`,`accessKey`,`secretKey`,`domain`,`bucket`,`uploadWay`,`maxAge`,`dataCache`,`createdAt`,`updatedAt`) values 
(1,'default','s','x','x','x','x','x','1','2','2','2023-10-07 21:52:21','2023-11-08 11:44:23');
...
insert  into `sys_role`(`id`,`name`,`value`,`sort`,`status`,`remark`,`createdAt`,`updatedAt`) values 
(1,'超级管理员','super',0,'1',NULL,'2023-10-30 21:57:52','2023-10-30 22:00:50'),
(2,'普通管理员','admin',0,'1',NULL,'2023-10-30 22:01:04','2023-10-30 22:01:04'),
(3,'编辑管理','editor',0,'1',NULL,'2023-10-30 22:01:11','2023-10-30 22:02:14');
...
insert  into `sys_user`(`id`,`role_id`,`username`,`password`,`status`,`remark`,`createdAt`,`updatedAt`) values 
(1,'2','chanyue','1d73632ebe6497078f6744bf79bd2861','1',NULL,'2023-10-30 22:42:01','2023-10-30 23:39:18'),
(2,'1','yanyutao','1d73632ebe6497078f6744bf79bd2861','1',NULL,'2023-10-30 22:42:18','2023-10-30 23:55:42'),
(3,'3','张三','1d73632ebe6497078f6744bf79bd2861','1',NULL,'2023-10-31 00:06:55','2023-10-31 00:06:55');
