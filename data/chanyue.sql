...
) ENGINE=InnoDB AUTO_INCREMENT=52 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='文章表';
...
(49,9,'','测试','','','1,3','','','','','','测试','/public/cover/01.jpg','<p>测试</p>',0,5,'','2023-11-07 11:08:35','2023-11-25 12:58:24'),
...
) ENGINE=InnoDB AUTO_INCREMENT=101 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='文章-标签表';
...
CREATE TABLE `field` (
  ...
  `field_length` varchar(255) DEFAULT NULL COMMENT '字段长度',
  PRIMARY KEY (`id`) USING BTREE,
...
insert  into `field`(`id`,`model_id`,`field_cname`,`field_ename`,`field_type`,`field_values`,`field_default`,`field_sort`,`field_length`) values 
(1,1,'下载名称','downName','1','','','0',NULL),
(2,1,'下载链接','downLink','1','','','0',NULL);
...
insert  into `gather`(`id`,`taskName`,`targetUrl`,`parseData`,`cid`,`status`,`createdAt`,`updatedAt`) values 
(3,'60s1','https://api.qqsuu.cn/api/dm-60s?type=json','let obj = {\n	title:\'\',\n	content:\'\'\n}\nif(data.success){\n	obj.title = data.name;\n	let p = \'\';\n	data.data.forEach((item)=>{\n	  p += \'<p>\'+item +\'</p>\'\n	});\n	obj.content = p;\n}\nreturn obj;',1,'2','2023-11-29 19:10:45','2023-12-01 00:07:22'),
(4,'60秒看世界','http://www.wudada.online/Api/ScD','let obj = {\n  title:\'\',\n  content:\'\'\n}\nif(data.code == 200){\n  let data = data.data;\n  const {cdate,title,content} = data;\n  obj.title = title+cdate;\n  let p = \'\';\n  content.forEach((item)=>{\n    p += \'<p>\'+item.content +\'</p>\'\n  });\n  obj.content = p;\n}else{\nconst {msg} = data;\nobj.title = msg;\n}\nreturn obj;',1,'1','2023-12-01 00:03:35','2023-12-01 00:11:08');
...
(1,'前端小栈','www.angyi.com','867528315@qq.com',NULL,NULL,'','禅悦','chanyue-cms禅悦内容管理系统','chanyue-cms|禅悦cms|nodejs|express|mysql','禅悦CMS是一款基于Express和MySQL研发的高质量实用型CMS管理系统。它具备多种类型网站开发，易扩展、基于模块化和插件化开发模式，适用于商用企业级程序开发。',NULL,NULL,NULL,NULL,'2023-11-26 11:56:32');
